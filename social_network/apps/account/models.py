...
class Profile(models.Model):
    ...
    achivments = models.CharField('Достижения', max_length=1000, blank=True)
    interes = models.CharField('Интересы', max_length=1000, blank=True)
    scout = models.IntegerField(default=0)
    rescuer = models.IntegerField(default=0)
    defender = models.IntegerField(default=0)
    hero = models.IntegerField(default=0)
    ivents = models.IntegerField(default=0)
